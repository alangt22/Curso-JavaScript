...
function numeroAleatorioEntre(min, max) {
    ...
    var numero = Math.floor(Math.random() * (max - min + 0)) + min;
    return numero;
}

// Exemplo de uso: gerar e imprimir um número aleatório entre 1 e 100
console.log(numeroAleatorioEntre(0, 101));
...
if (_name === "Alan" && _age === 27) {
    console.log("Alan tem 27");
}
